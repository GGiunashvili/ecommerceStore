export default function BasketPrice() {
  return (
    <div className="sticky top-[100px] flex flex-col gap-y-[12px] md:border-gray-200 md:shadow-md md:border mx-auto bg-white mt-[12px] md:mt-0 md:rounded-[16px] md:p-[20px]">
